...
public class V2ManualTrialReadyToRunGateServiceTest {

    private V2ManualTrialReadyToRunGateService service;

    @BeforeEach
    public void setUp() {
        service = new V2ManualTrialReadyToRunGateService();
    }

    @AfterEach
    public void tearDown() {
        System.clearProperty(V2SubmitFeatureFlags.FLAG_V2_MANUAL_TRIAL_READY_TO_RUN_GATE);
        System.clearProperty("tse.v2.defaultStudentSubmitV2.enabled");
    }

    @Test
    public void testFlagOff() {
        System.setProperty(V2SubmitFeatureFlags.FLAG_V2_MANUAL_TRIAL_READY_TO_RUN_GATE, "false");
        V2ManualTrialReadyToRunGateResult result = service.checkGate();
    ...
    public void testGateReadyWithPendingTestAccount() {
        System.setProperty(V2SubmitFeatureFlags.FLAG_V2_MANUAL_TRIAL_READY_TO_RUN_GATE, "true");
