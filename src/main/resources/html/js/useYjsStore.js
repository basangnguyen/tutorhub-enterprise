import { InstancePresenceRecordType, computed, createPresenceStateDerivation, createTLStore, defaultShapeUtils, defaultUserPreferences, getUserPreferences, setUserPreferences, react, } from 'tldraw';
import { useEffect, useMemo, useState } from 'react';
import { YKeyValue } from 'https://esm.sh/y-utility/y-keyvalue';
import { WebsocketProvider } from 'https://esm.sh/y-websocket';
import * as Y from 'https://esm.sh/yjs';
export function useYjsStore({ roomId = 'example', hostUrl = 'ws://localhost:1234', shapeUtils = [], }) {
