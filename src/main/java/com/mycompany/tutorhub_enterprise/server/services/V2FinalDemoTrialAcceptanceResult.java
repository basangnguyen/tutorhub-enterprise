...
public class V2FinalDemoTrialAcceptanceResult {
    private boolean success;
    private boolean ready;
    private String decision;
    private String errorCode;
    private String dbTargetStatus;
    private String testAccountStatus;
    private String testExamStatus;
    private String testAttemptStatus;
    private String manualTrialStatus;
    private String submitRouteObserved;
    private String doubleSubmitObserved;
    ...
    public V2FinalDemoTrialAcceptanceResult() {
    ...
    public String getDbTargetStatus() { return dbTargetStatus; }
    public void setDbTargetStatus(String dbTargetStatus) { this.dbTargetStatus = dbTargetStatus; }
    ...
    public String getTestExamStatus() { return testExamStatus; }
    public void setTestExamStatus(String testExamStatus) { this.testExamStatus = testExamStatus; }
    public String getTestAttemptStatus() { return testAttemptStatus; }
    public void setTestAttemptStatus(String testAttemptStatus) { this.testAttemptStatus = testAttemptStatus; }
    ...
    public String getSubmitRouteObserved() { return submitRouteObserved; }
    public void setSubmitRouteObserved(String submitRouteObserved) { this.submitRouteObserved = submitRouteObserved; }
    public String getDoubleSubmitObserved() { return doubleSubmitObserved; }
    public void setDoubleSubmitObserved(String doubleSubmitObserved) { this.doubleSubmitObserved = doubleSubmitObserved; }
