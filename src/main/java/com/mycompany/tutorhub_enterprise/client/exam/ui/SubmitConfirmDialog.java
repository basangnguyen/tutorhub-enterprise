...
/**
 * SubmitConfirmDialog – Confirm dialog before submitting exam.
 *
...
public class SubmitConfirmDialog extends JDialog {
    ...
    public SubmitConfirmDialog(JFrame parent, Runnable onConfirm) {
        super(parent, true);
        setUndecorated(true);
    ...
    private JPanel buildTitleBar() {
        ...
        // Warning icon (Graphics2D triangle) + text — no ⚠ unicode
        JLabel lblTitle = ExamIconFactory.warningLabel("Xác nhận nộp bài");
        lblTitle.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        lblTitle.setForeground(Color.decode("#222222"));

        // Close X button (Graphics2D) — no "✕" text
    ...
    private JPanel buildBody() {
        ...
        JLabel lbl1 = new JLabel("Bạn có chắc chắn muốn nộp bài thi ngay lúc này?");
        lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        lbl1.setForeground(Color.decode("#222222"));

        JLabel lbl2 = new JLabel("Sau khi nộp, bạn sẽ không thể thay đổi câu trả lời.");
    ...
    private JPanel buildFooter(Runnable onConfirm) {
        ...
        JButton btnConfirm = new JButton("Nộp Bài");
        btnConfirm.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        btnConfirm.setBackground(Color.decode("#1B5E8B"));
