...
public class MapPickerDialog extends JDialog {
    ...
    public void dispose() {
        try {
            ...
            Class<?> clazz = cefClient.getClass();
            while (clazz != null) {
                try {
                    method = clazz.getDeclaredMethod("removeLoadHandler", org.cef.handler.CefLoadHandler.class);
                    break;
            ...
            if (method != null) {
                ...
                method.invoke(cefClient, loadHandler);
            }
