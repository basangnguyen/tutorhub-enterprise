...
new_flags = """    public static final String FLAG_V2_DEMO_RELEASE_CANDIDATE_ARCHIVE_GATE = "tse.v2.demoReleaseCandidateArchiveGate.enabled";
"""
new_methods = """    public static boolean isDemoReleaseCandidateArchiveGateEnabled() {
...
new_actions = """    public static final String EXAM_SUBMIT_V2_DEMO_RELEASE_CANDIDATE_ARCHIVE_GATE = "EXAM_SUBMIT_V2_DEMO_RELEASE_CANDIDATE_ARCHIVE_GATE";
"""
idx2 = content.rfind('}')
...
new_cases = """
                case V2SubmitActions.EXAM_SUBMIT_V2_DEMO_RELEASE_CANDIDATE_ARCHIVE_GATE: {
                    com.mycompany.tutorhub_enterprise.server.services.V2DemoReleaseCandidateArchiveGateService service = new com.mycompany.tutorhub_enterprise.server.services.V2DemoReleaseCandidateArchiveGateService();
                    com.mycompany.tutorhub_enterprise.server.services.V2DemoReleaseCandidateArchiveGateResult result = service.checkGate();
                    sendPacket(new Packet(req.getType(), new com.google.gson.Gson().toJson(result)));
                    break;
                }
"""

marker = 'case V2SubmitActions.EXAM_SUBMIT_V2_DEMO_PACKAGE_FREEZE_GATE:'
...
print("Updated Java sources phase 19")
