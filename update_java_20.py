...
new_flags = """    public static final String FLAG_V2_DEMO_RC_CLOSEOUT_GATE = "tse.v2.demoRcCloseoutGate.enabled";
"""
new_methods = """    public static boolean isDemoRcCloseoutGateEnabled() {
...
new_actions = """    public static final String EXAM_SUBMIT_V2_DEMO_RC_CLOSEOUT_GATE = "EXAM_SUBMIT_V2_DEMO_RC_CLOSEOUT_GATE";
"""
idx2 = content.rfind('}')
...
new_cases = """
                case V2SubmitActions.EXAM_SUBMIT_V2_DEMO_RC_CLOSEOUT_GATE: {
                    com.mycompany.tutorhub_enterprise.server.services.V2DemoRcCloseoutGateService service = new com.mycompany.tutorhub_enterprise.server.services.V2DemoRcCloseoutGateService();
                    com.mycompany.tutorhub_enterprise.server.services.V2DemoRcCloseoutGateResult result = service.checkGate();
                    sendPacket(new Packet(req.getType(), new com.google.gson.Gson().toJson(result)));
                    break;
                }
"""

marker = 'case V2SubmitActions.EXAM_SUBMIT_V2_DEMO_RELEASE_CANDIDATE_ARCHIVE_GATE:'
...
print("Updated Java sources phase 20")
