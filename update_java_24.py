...
new_flags = """    public static final String FLAG_V2_FINAL_MANUAL_TRIAL_RESULT_GATE = "tse.v2.finalManualTrialResultGate.enabled";
"""
new_methods = """    public static boolean isFinalManualTrialResultGateEnabled() {
...
new_actions = """    public static final String EXAM_SUBMIT_V2_FINAL_MANUAL_TRIAL_RESULT_GATE = "EXAM_SUBMIT_V2_FINAL_MANUAL_TRIAL_RESULT_GATE";
"""
idx2 = content.rfind('}')
...
new_cases = """
                case V2SubmitActions.EXAM_SUBMIT_V2_FINAL_MANUAL_TRIAL_RESULT_GATE: {
                    com.mycompany.tutorhub_enterprise.server.services.V2FinalManualTrialResultGateService service = new com.mycompany.tutorhub_enterprise.server.services.V2FinalManualTrialResultGateService();
                    com.mycompany.tutorhub_enterprise.server.services.V2FinalManualTrialResultGateResult result = service.checkGate();
                    sendPacket(new Packet(req.getType(), new com.google.gson.Gson().toJson(result)));
                    break;
                }
"""

marker = 'case V2SubmitActions.EXAM_SUBMIT_V2_DEMO_RC_FINAL_ACCEPTANCE_DECISION:'
...
print("Updated Java sources phase 24")
