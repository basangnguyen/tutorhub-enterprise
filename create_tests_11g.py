...
tests_content = '''package com.mycompany.tutorhub_enterprise.server.services;
...
public class Phase11Gto11JTest {
    ...
    void testFallbackGuard_ExceptionInCheck_ReturnsForbidden() {
        ...
        V2StudentSubmitLegacyFallbackRuntimeGuardService guardService = new V2StudentSubmitLegacyFallbackRuntimeGuardService(
            new MockSubmitRecordDAO(false) {
                @Override
                public java.util.Optional<com.mycompany.tutorhub_enterprise.server.dao.V2SubmitRecord> findLatestByAttemptId(String attemptId) {
    ...
    private static class MockPreflightService extends V2ManualCandidateActualSubmitPreflightService {
        ...
        @Override
        public V2ManualCandidateActualSubmitPreflightResult executePreflight(int u, String a, String p) {
    ...
    private static class MockMaterializationService extends V2ManualCandidateSubmitRecordMaterializationService {
        ...
        @Override
        public V2ManualCandidateSubmitRecordMaterializationResult executeMaterialization(int u, String a, String p) {
            V2ManualCandidateSubmitRecordMaterializationResult r = new V2ManualCandidateSubmitRecordMaterializationResult();
            r.setSuccess(success);
            r.setSubmitRecordId(id);
            return r;
        }
    }
    ...
    private static class MockStatusExecutionService extends V2ManualCandidateSubmitStatusExecutionService {
        ...
        @Override
        public V2ManualCandidateSubmitStatusExecutionResult executeStatusUpdate(int u, String a) {
    ...
    private static class MockScoreService extends V2ManualCandidateScoreOfficialDraftExecutionService {
        ...
        @Override
        public V2ManualCandidateScoreOfficialDraftExecutionResult executeDraftGeneration(int u, String a, String p) {
    ...
    private static class MockPublicationService extends V2ManualCandidateExamResultsPublicationService {
        ...
        @Override
        public V2ManualCandidateExamResultsPublicationResult executePublication(int u, String a) {
            V2ManualCandidateExamResultsPublicationResult r = new V2ManualCandidateExamResultsPublicationResult();
            r.setSuccess(success);
            r.setExamResultId(id);
            return r;
        }
    }
    ...
    private static class MockFinalStatusService extends V2ManualCandidateFinalStatusExecutionService {
        ...
        public V2ManualCandidateFinalStatusExecutionResult executeFinalStatus(int u, String a) {
            V2ManualCandidateFinalStatusExecutionResult r = new V2ManualCandidateFinalStatusExecutionResult();
            r.setSuccess(success);
            return r;
        }
    }
    ...
    private static class MockVerificationService extends V2ManualCandidateResultHandoffVerificationService {
        ...
        public V2ManualCandidateResultHandoffVerificationResult verifyHandoff(int u, String a) {
            V2ManualCandidateResultHandoffVerificationResult r = new V2ManualCandidateResultHandoffVerificationResult();
            r.setSuccess(success);
            return r;
        }
    }
    ...
    private static class MockSubmitRecordDAO extends com.mycompany.tutorhub_enterprise.server.dao.V2SubmitRecordDAO {
        ...
        @Override
        public java.util.Optional<com.mycompany.tutorhub_enterprise.server.dao.V2SubmitRecord> findLatestByAttemptId(String attemptId) {
            if (hasRecord) return java.util.Optional.of(new com.mycompany.tutorhub_enterprise.server.dao.V2SubmitRecord());
    ...
    private static class MockPublicationLedgerDAO extends com.mycompany.tutorhub_enterprise.server.dao.V2ResultPublicationLedgerDAO {
        ...
        @Override
        public List<com.mycompany.tutorhub_enterprise.server.dao.V2ResultPublicationLedger> findByAttemptId(String attemptId) {
            if (hasRecords) {
                List<com.mycompany.tutorhub_enterprise.server.dao.V2ResultPublicationLedger> list = new java.util.ArrayList<>();
                list.add(new com.mycompany.tutorhub_enterprise.server.dao.V2ResultPublicationLedger());
                return list;
            }
...
test_path = r'D:\Ban_sao_du_an\src\test\java\com\mycompany\tutorhub_enterprise\server\services\Phase11Gto11JTest.java'
