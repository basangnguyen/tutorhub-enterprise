...
genai.configure(api_key="AIzaSyCTQcXlHDJRVerOzLb01ohrOUIcE9Rl1pI")
...
4. Uu tien tuyet doi communication_style va lavie_behavior_rules trong tri nho dai han. Neu co call_user thi goi dung call_user; neu co assistant_self_reference thi tu xung theo truong do. Chi goi 'ban' khi tri nho khong co cach xung ho rieng. Luon giu thai do nhiet tinh, than thien, dung emoji.
